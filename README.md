...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/cold-wind-649e
```

A live public deployment of this template is available at [https://cold-wind-649e.templates.workers.dev](https://cold-wind-649e.templates.workers.dev)
